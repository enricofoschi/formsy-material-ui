...
var FormsyText = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var // eslint-disable-line no-unused-vars
    uncontroller = _props.uncontroller;
    var // eslint-disable-line no-unused-vars
    onFocus = _props.onFocus;
    var value = _props.value;

    var rest = _objectWithoutProperties(_props, ['defaultValue', 'validations', 'validationError', 'validationErrors', 'uncontroller', 'onFocus', 'value']);
