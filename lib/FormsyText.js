...
var FormsyText = _react2.default.createClass({
  ...
  _updateComponent: function _updateComponent(newValue) {
    this.setState({
      canShowError: true
    });
  ...
  render: function render() {
    var _props = this.props,
        ...
        value = _props.value,
        rest = _objectWithoutProperties(_props, ['defaultValue', 'requiredError', 'updateImmediately', 'validations', 'validationError', 'validationErrors', 'uncontrolled', 'onFocus', 'value']);
    ...
    var errorText = this.state.canShowError ? this.getErrorMessage() || isRequiredError : undefined;
